...
class DynamoTable {
  ...
  put(key, amount, clickid, customer, shipping_address, billing_address, product, tax_rate, tax_amount, ship_amount, trans_id, trans_type, order_type, shopify_order_id, shopify_order_name) {
